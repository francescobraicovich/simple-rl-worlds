...
def init_vit_mae(config_path: str = None):
    ...
    config = ViTMAEConfig(
            ...
            hidden_size=128,                # your “latent_dim”
            num_hidden_layers=4,           # same depth as ViT‐Base
            ...
            decoder_hidden_size=128,        # mirror encoder latent
            decoder_num_hidden_layers=4,    # shallow “head”
